...
2. All files were named appropriately. Reports are provided in .pdf format, and SQL code is provided in .txt format.

3. Each file name includes a suffix indicating the order in which it was created, following the logical workflow of database development.

4. Every action performed is documented either in the .txt files or within the reports.

5. Some additional work was included because the assignment was enjoyable. Specifically:
